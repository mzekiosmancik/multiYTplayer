    ...
    <div class="offcanvas offcanvas-end text-bg-dark" tabindex="-1" id="offcanvasRight" aria-labelledby="offcanvasRightLabel" data-bs-scroll="true" >
        <div class="offcanvas-header">
            <h4 class="offcanvas-title" id="offcanvasRightLabel">
                ...
                <span>Multi YT | Settings</span></h4>
            <div>
        ...
        <div class="offcanvas-body">
            ...
            <div class="btn-group w-100" role="group" aria-label="Settings">
                <a type="button" class="btn btn-outline-light rounded-0 <?php echo $langpath ==
                "?"
                    ? " active"
                    : ""; ?>" href="<?php echo $path; ?>">Turkish</a>
                <a type="button" class="btn btn-outline-light rounded-0  <?php echo $langpath ==
                "?lang=eng"
                    ? " active"
                    : ""; ?>" href="<?php echo $path,
    "lang=eng"; ?>">English</a>
            ...
            <form methot="get" action="">
                ...
                <div class="form-check form-switch">
                    <?php echo $autoplay == 1
                        ? '<input type="hidden" value="off" name="autoplay">'
                        : ""; ?>
                    <input class="form-check-input" type="checkbox" role="switch" id="autoplay" name="autoplay" <?php echo $autoplay ==
                    1
                        ? ' checked="checked"'
                        : ""; ?>>
...
<?php } ?> 
            ...
            <div class="mt-2 py-2 text-center position-absolute bottom-0 start-50 translate-middle-x text-bg-dark" style="font-size:.78em; width: 368px;">
                <a href="" rel="external noopener" target="_blank" class="link-light text-decoration-none">Mezo</a>
            </div>
        </div>
    </div>
